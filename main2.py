            ...
            for numProcessadores in listaProcessadores:
                for variacaoTempoExecucao in variacaoTempoExecucaoLista:
                    for variacaoCustoComunicacao in variacaoCustoComunicacaoLista:
                        ...
                        nomeGrafo = f'rand0{indiceGrafo}-{numProcessadores}-{variacaoTempoExecucao}-{variacaoCustoComunicacao}.stg'
...
if __name__ == '__main__':
    ...
    listaProcessadores = [4, 2]
    variacaoTempoExecucaoLista = [20, 40]
    variacaoCustoComunicacaoLista = [30]
    numTarefasLista = [50]
    diretorioBase = 'grafos_breno/'

    iteracoes_mse = 2
    tamanhoPopulacao_mse = 20
    ...
    #                                         tamanhoPopulacao_mse, chanceCrossoverAlocacao_mse, chanceCrossoverEscalonamento_mse, chanceMutacaoAlocacao_mse, chanceMutacaoEscalonamento_mse, taxaElitismo_mse)

    # print('MSE')
    # print(json.dumps(melhoresIndividuosMSE, indent=4))

    resultados_breno = experimento_breno(
        listaProcessadores, variacaoTempoExecucaoLista, variacaoCustoComunicacaoLista, numTarefasLista, diretorioBase)
